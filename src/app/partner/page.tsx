...
export default function PartnerPage() {
  return (
    <>
      ...
      <Section icon="fa-solid fa-compass" title="Beyond Transactional: Building Authentic Community Relationships">
      ...
      <Section icon="fa-solid fa-link" title="Diverse Partnership Models" id="partnership-types">
        <div className="grid grid-2">
          {[
            { icon: 'fa-solid fa-graduation-cap', title: 'Educational Institution Partnerships', desc: 'Curriculum integration, teacher professional development, family engagement programming', partners: ['Austin ISD Creative Arts Integration', 'Community College Pathway Programming', 'University Research Collaborations'] },
            { icon: 'fa-solid fa-briefcase', title: 'Workforce and Industry Partnerships', desc: 'Professional mentorship, internship opportunities, career pathway development', partners: ['Local Creative Agencies', 'Technology Companies', 'Nonprofit Organizations'] },
            { icon: 'fa-solid fa-users', title: 'Community Organization Partnerships', desc: 'Shared programming, community storytelling projects, resource sharing', partners: ['Austin History Center', 'Neighborhood Associations', 'Cultural Organizations'] },
      ...
      <Section icon="fa-solid fa-trophy" title="Real Partnerships, Real Community Impact">
      ...
      <Section icon="fa-solid fa-chart-line" title="From Initial Conversation to Deep Collaboration">
        <div className="grid grid-3">
          {[
      ...
      <Section icon="fa-solid fa-door-open" title="Ready to Explore Partnership with E4 Youth?" lead="Let's start a conversation about how we can work together to expand creative learning opportunities and strengthen our community.">
