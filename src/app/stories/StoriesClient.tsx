...
const stories = [
  { title: 'Walking Through History', desc: 'Youth participants created an augmented reality experience that brings Black Austin history to life in public spaces, connecting past and present through technology and storytelling.', tag: 'AR Experience', color: '#9B51E0' },
  { title: 'Voices of the Community', desc: 'An oral history project that captured stories from three generations of Austin families, preserving memories and perspectives that might otherwise be lost.', tag: 'Oral History', color: '#FCB900' },
  { title: 'Creative Futures', desc: 'High school participants developed professional portfolios and presented their work at a public showcase, gaining confidence and visibility as emerging creatives.', tag: 'Student Showcase', color: '#4DB8FF' },
  { title: 'Heritage Remix', desc: 'College-aged participants combined traditional cultural practices with emerging technology to create interactive installations for community spaces.', tag: 'Innovation', color: '#7BDCB5' },
  { title: 'Digital Storytellers', desc: 'Youth learned video production, audio editing, and digital publishing to tell stories about their neighborhoods, schools, and communities.', tag: 'Digital Media', color: '#0072CE' },
  { title: 'Community Connection', desc: 'An E4 Live networking event brought together over 100 creatives, professionals, and community members for an evening of connection and collaboration.', tag: 'E4 Live', color: '#9B51E0' },
]
            ...
            {stories.map((story, i) => (
              <AnimatedSection key={story.title} delay={i * 0.08}>
                <div className="bg-white rounded-2xl overflow-hidden shadow-md border border-gray-100 card-hover h-full flex flex-col">
                  <div className="h-48 bg-gradient-to-br" style={{ backgroundImage: `linear-gradient(135deg, ${story.color}33, ${story.color}11)` }}>
                    <div className="h-full flex items-center justify-center">
                      <FontAwesomeIcon icon="circle-play" className="w-16 h-16 opacity-30" style={{ color: story.color }} />
                    </div>
                  </div>
