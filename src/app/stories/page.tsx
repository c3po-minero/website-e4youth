...
export default function StoriesPage() {
  return (
    <>
      <Hero title="Real Stories, Real Impact, Real Community Change" lead="Stories & Showcases highlight youth voices, project outcomes, and public storytelling experiences across E4 Youth programs." bgImage="https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=1920&h=1080&fit=crop" icon="🎤" buttons={[{ label: 'Explore Stories', href: '#stories', variant: 'primary' }, { label: 'Attend a Showcase', href: '#showcases', variant: 'secondary' }]} />

      <Section icon="❤️" title="More Than Success Stories: Authentic Community Narratives">
        <div className="grid grid-2">
          {[
            { icon: '👤', title: 'Participant Ownership', desc: 'Stories are told by participants in their own words and on their own terms' },
            { icon: '👥', title: 'Community Context', desc: 'Individual growth is always connected to broader community relationships' },
            { icon: '🛤️', title: 'Ongoing Journey', desc: 'We highlight progress and learning rather than just completion moments' },
            { icon: '⭐', title: 'Diverse Outcomes', desc: 'Success takes many forms, from creative confidence to career advancement' },
      ...
      <Section icon="👥" title="Voices From Our Community" id="stories">
        <div className="grid grid-2">
      ...
      <Section icon="🏠" title="Family and Community Perspectives">
      ...
      <Section icon="🖼️" title="Community Portfolio Showcases" id="showcases">
        <div className="grid grid-3">
          {[
      ...
      <Section icon="🙌" title="Be Part of the Story">
        <div className="grid grid-3">
          <div className="card"><span className="card-icon">➕</span><h3 className="card-title">Share Your Story</h3><p className="card-description">Current and former participants can contribute their stories.</p><div className="card-cta"><Link href="/contact" className="btn btn-accent">Submit Your Story</Link></div></div>
          <div className="card"><span className="card-icon">📅</span><h3 className="card-title">Attend Showcases</h3><p className="card-description">Join community events to see participant work and support youth voices.</p><div className="card-cta"><Link href="/contact" className="btn btn-accent">View Event Calendar</Link></div></div>
          <div className="card"><span className="card-icon">🤝</span><h3 className="card-title">Support Community Voices</h3><p className="card-description">Professional mentors and organizations can support showcase events.</p><div className="card-cta"><Link href="/partner" className="btn btn-accent">Partner With Us</Link></div></div>
        </div>
      </Section>

      <Section icon="📧" title="Connect With Community Stories">
