...
export default function WOWPage() {
  return (
    <>
      ...
      <Section icon="📍" title="Experience History Where It Happened" lead="Using your smartphone, discover historical markers that come alive with stories, images, and voices from Austin's Black community leaders and historians." id="tour-info">
        <div className="grid grid-3">
          <div className="card"><span className="card-icon">📱</span><h3>How It Works</h3><ol><li>Download the WOW app</li><li>Visit participating locations</li><li>Point your phone at AR markers</li><li>Experience immersive stories</li></ol></div>
          <div className="card"><span className="card-icon">🗺️</span><h3>Featured Locations</h3><ul><li>Historic East Austin neighborhoods</li><li>Former Blackshear School site</li><li>Victory Grill and music venues</li><li>Community gathering spaces</li></ul></div>
          <div className="card"><span className="card-icon">👥</span><h3>Community Voices</h3><ul><li>Elder community storytellers</li><li>Local historians and researchers</li><li>Youth documentarians</li><li>Neighborhood residents</li></ul></div>
        </div>
      </Section>

      <Section icon="🤝" title="Community-Developed Stories">
      ...
      <Section icon="📅" title="Join a Guided Tour">
        <div className="grid grid-2">
          <div className="card">
