...
export default function HeritageCenterPage() {
  return (
    <>
      <Hero title="A Physical Home for Community Stories" lead="The WOW Heritage Center serves as E4 Youth's community hub—a welcoming space where neighbors gather to share stories, learn new skills, access resources, and build connections." bgImage="https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?w=1920&h=1080&fit=crop" icon="🏠" buttons={[{ label: 'Visit the Center', href: '#contact', variant: 'primary' }, { label: 'Reserve Space', href: '#rental', variant: 'secondary' }]} />

      <Section icon="🏡" title="More Than a Building - A Community Home" lead="The WOW Heritage Center operates as both a neighborhood gathering place and a specialized hub for community storytelling work.">
        <div className="grid grid-2">
          <div className="card"><span className="card-icon">👥</span><h3 className="card-title">Community Gathering Space</h3><p className="card-description">Free, accessible venue for neighborhood meetings, celebrations, and informal connection</p></div>
          <div className="card"><span className="card-icon">🎥</span><h3 className="card-title">Storytelling Production Hub</h3><p className="card-description">Professional-grade equipment and technical support for community story creation</p></div>
          <div className="card"><span className="card-icon">🎓</span><h3 className="card-title">Learning &amp; Workshop Center</h3><p className="card-description">Regular programming in digital literacy, creative skills, and community engagement</p></div>
          <div className="card"><span className="card-icon">📚</span><h3 className="card-title">Community Archive &amp; Resource Center</h3><p className="card-description">Physical and digital archives accessible to community members and researchers</p></div>
        </div>
      </Section>

      <Section icon="🏢" title="Designed for Community, Built for Stories">
      ...
      <Section icon="🔑" title="Your Community Space - Use It!" lead="The WOW Heritage Center prioritizes community use and keeps rental costs low to ensure accessibility." id="rental">
        <div className="grid grid-2">
          <div className="card"><span className="card-icon">👥</span><h3 className="card-title">Community Organization Meetings</h3><p className="card-description"><strong>Rate:</strong> Free for registered community organizations<br /><strong>Includes:</strong> Basic room setup, AV equipment, kitchen access</p></div>
          <div className="card"><span className="card-icon">🎂</span><h3 className="card-title">Private Community Events</h3><p className="card-description"><strong>Rate:</strong> $50-150 sliding scale<br /><strong>Includes:</strong> Space rental, basic setup, kitchen access</p></div>
          <div className="card"><span className="card-icon">🎓</span><h3 className="card-title">Nonprofit &amp; Educational Events</h3><p className="card-description"><strong>Rate:</strong> $25-100 sliding scale<br /><strong>Includes:</strong> Space, AV support, promotional support</p></div>
          <div className="card"><span className="card-icon">💼</span><h3 className="card-title">Small Business &amp; Professional Use</h3><p className="card-description"><strong>Rate:</strong> Market rate ($150-300)<br /><strong>Includes:</strong> Professional space rental with full AV and hospitality support</p></div>
        </div>
        <div className="text-center mt-lg"><Link href="#contact" className="btn btn-primary">Reserve Community Space</Link></div>
      </Section>

      <Section icon="🗺️" title="Come See Us - You're Always Welcome" id="contact">
        <div className="grid grid-2">
          <div>
