...
export default function LevelUpPage() {
  return (
    <>
      <Hero title="Level Up: Where Skills Meet Strategy" lead="E4 Level Up is an advanced workshop and professional development series for college-aged, early-career, and established creatives." bgImage="https://images.unsplash.com/photo-1531482615713-2afd69097998?w=1920&h=1080&fit=crop" icon="📈" buttons={[{ label: 'Explore Workshops', href: '#workshops', variant: 'primary' }, { label: 'Partner on Level Up', href: '#partnership', variant: 'secondary' }]} />

      <Section icon="🧭" title="Beyond Basic Training: Strategic Creative Development" lead="E4 Level Up recognizes that today's creative professionals must be both technically excellent and strategically minded.">
        <div className="grid grid-2">
          {[
            { icon: '📋', title: 'Applied Learning', desc: 'Every workshop centers real projects and challenges' },
            { icon: '🏭', title: 'Industry Integration', desc: 'Working professionals co-facilitate workshops' },
            { icon: '📁', title: 'Portfolio Development', desc: 'Participants leave with tangible work samples' },
            { icon: '♟️', title: 'Strategic Thinking', desc: 'Technical skills training integrates business strategy' },
      ...
      <Section icon="📚" title="Specialized Learning Tracks" id="workshops">
        <div className="grid grid-2">
          {[
      ...
      <Section icon="⭐" title="Professional Development That Delivers Results">
      ...
      <Section icon="🤝" title="Industry Partners Make Level Up Possible" id="partnership">
        <div className="grid grid-2">
          ...
          <div className="card"><span className="card-icon">👨‍🏫</span><h3 className="card-title">Professional Mentors</h3><p className="card-description">Working professionals co-facilitate workshops and provide ongoing mentorship.</p><div className="card-cta"><Link href="/contact" className="btn btn-accent">Join as a Mentor</Link></div></div>
        </div>
      </Section>

      <Section icon="📋" title="Ready to Level Up Your Creative Career?">
        <div className="grid grid-2">
          <div>
