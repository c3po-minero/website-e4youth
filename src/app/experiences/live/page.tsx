...
export default function LivePage() {
  return (
    <>
      <Hero title="E4 Live: Where Stories Spark Opportunities" lead="E4 Live is a dynamic series of in-person networking events that celebrate creativity, connection, and community." bgImage="https://images.unsplash.com/photo-1511632765486-a01980e01a18?w=1920&h=1080&fit=crop" icon="fa-solid fa-users" buttons={[{ label: 'Attend Next E4 Live', href: '#upcoming', variant: 'primary' }, { label: 'Partner on E4 Live', href: '#partnership', variant: 'secondary' }]} />

      <Section icon="fa-solid fa-handshake" title="More Than Networking: Building Creative Community" lead="E4 Live creates spaces where relationships form naturally around shared creative work and mutual inspiration.">
        <div className="grid grid-2">
          {[
            { icon: 'fa-solid fa-book-open', title: 'Story-Centered', desc: 'Every event centers participant work, creating genuine conversation starters' },
      ...
      <Section icon="fa-solid fa-calendar" title="What to Expect at E4 Live">
        <div className="grid grid-3">
          {[
            { icon: 'fa-solid fa-comments', title: 'Pre-Event Connection', desc: 'Registered participants receive digital portfolios showcasing featured work.' },
            { icon: 'fa-solid fa-desktop', title: 'Creative Showcases', desc: '6-8 emerging creatives presenting their latest work in 3-minute spotlight presentations.' },
            { icon: 'fa-solid fa-arrows-rotate', title: 'Facilitated Connections', desc: 'Structured activities that help attendees connect around shared interests.' },
      ...
      <Section icon="fa-solid fa-trophy" title="Real Connections, Real Opportunities">
        <div className="grid grid-3">
          {[
