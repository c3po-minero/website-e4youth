...
export default function Home() {
  return (
    <>
      ...
      <Section icon="🧭" title="Stories Shape Futures" lead="At E4 Youth, we believe every young person has a story worth telling—and skills worth developing. Through innovative programs that blend storytelling with digital literacy, we create transformative experiences where creativity meets opportunity.">
      ...
      <Section icon="🚀" title="The Four E's That Drive Change">
        <div className="grid grid-2">
          {[
            { icon: '🤝', title: 'Engage', desc: 'We meet young people where they are, honoring their experiences and perspectives as valuable starting points for growth.' },
            { icon: '🎓', title: 'Educate', desc: 'Through hands-on workshops and mentorship, participants develop both creative and technical skills that translate directly to academic and professional success.' },
            { icon: '✊', title: 'Empower', desc: 'We provide platforms and opportunities for young voices to be heard, creating confidence and agency in personal and professional settings.' },
            { icon: '🔗', title: 'Elevate', desc: 'Participants leave our programs not just with skills, but with portfolios, networks, and clear pathways to their next opportunities.' },
          ].map((e) => (
            <div className="card" key={e.title}>
              <span className="card-icon">{e.icon}</span>
      ...
      <Section icon="🌉" title="Beyond Self-Expression: Storytelling as Infrastructure">
        <div className="grid grid-2">
          <div>
      ...
      <Section icon="📅" title="Jump In: Experiences Available Now">
      ...
      <Section icon="⭐" title="Real Stories, Real Impact">
        <div className="grid grid-3">
          {[
      ...
      <Section icon="➡️" title="Ready to Transform Your Story?" lead="Whether you're a young person ready to discover your potential, an educator seeking innovative programming, or a community partner interested in collaboration, E4 Youth has a place for you.">
        <div className="btn-group">
