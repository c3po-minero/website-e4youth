...
export default function FundersPage() {
  return (
    <>
      ...
      <Section icon="fa-solid fa-chart-line" title="Closing Critical Gaps in Youth Development" lead="Traditional youth programming creates artificial divisions between soft and hard skills. E4 Youth bridges them through storytelling.">
        <div className="grid grid-2">
          {[
            { icon: 'fa-solid fa-plug', title: 'Narrative-Professional Disconnect', desc: 'Young people develop identity and skills in isolation from career pathways' },
      ...
      <Section icon="fa-solid fa-gears" title="Why Storytelling is Workforce Development" lead="Storytelling isn't enrichment—it's infrastructure that builds communication, technical, and professional competencies.">
        <div className="grid grid-2">
          {[
      ...
      <Section icon="fa-solid fa-handshake" title="Flexible Collaboration Approaches" id="partnership-models">
        <div className="grid grid-2">
          {[
            { icon: 'fa-solid fa-gears', title: 'Program Development Partnerships', desc: 'Co-design customized programming', timeline: '3-6 months development, 12-month implementation', investment: '$25,000-75,000' },
            { icon: 'fa-solid fa-flask', title: 'Pilot Program Funding', desc: 'Support innovation and testing of new program models', timeline: '6-month pilot with 3-month evaluation', investment: '$15,000-40,000' },
            { icon: 'fa-solid fa-chart-bar', title: 'Capacity Building Investments', desc: 'Strengthen infrastructure to expand reach', timeline: 'Focus on staff development, technology, space', investment: '$10,000-100,000+' },
      ...
      <Section icon="fa-solid fa-chart-bar" title="Measurable Impact, Community-Defined Success">
      ...
      <Section icon="fa-solid fa-bullseye" title="Strategic Funding Priorities">
        <div className="grid grid-3">
          <div className="card">
      ...
      <Section icon="fa-solid fa-calendar" title="Begin the Conversation" lead="E4 Youth welcomes partnerships with funders who share our commitment to community-driven youth development.">
        <div className="grid grid-2">
          <div>
