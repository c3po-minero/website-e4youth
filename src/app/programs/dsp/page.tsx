...
export default function DSPPage() {
  return (
    <>
      ...
      <Section icon="🛠️" title="Skills That Serve You Everywhere">
        <div className="grid grid-2">
          <div className="card">
      ...
      <Section icon="📅" title="Flexible Learning That Fits Your Life" id="program-structure">
      ...
      <Section icon="⭐" title="Amazing Stories from Amazing Kids">
        <div className="grid grid-3">
          {[
      ...
      <Section icon="🚀" title="Ready to Discover Your Story?" id="getting-started">
        <div className="grid grid-2">
          <div className="card">
      ...
      <Section icon="📧" title="Let's Start the Conversation">
        <div className="grid grid-2">
          <div className="card">
