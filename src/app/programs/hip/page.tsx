...
export default function HIPPage() {
  return (
    <>
      ...
      <Section icon="🏔️" title="Where Leadership Meets Community Impact" lead="HIP participants don't just learn skills—they apply them in real community contexts, creating meaningful change while building professional experience." id="program-details">
      ...
      <Section icon="📋" title="Current HIP Projects">
        <div className="grid grid-3">
          ...
          ].map(c => <div className="card" key={c.title}><img src={c.img} alt={c.title} className="card-image" /><h3>{c.title}</h3><p className="card-description">{c.desc}</p></div>)}
        </div>
      </Section>

      <Section icon="💼" title="Professional Skills & Networks">
        <div className="grid grid-2">
      ...
      <Section icon="🏆" title="HIP Alumni Impact">
        <div className="grid grid-3">
          {[
      ...
      <Section icon="🚪" title="Ready to Lead?">
        <div className="grid grid-2">
