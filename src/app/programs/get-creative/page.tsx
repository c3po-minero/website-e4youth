...
export default function GetCreativePage() {
  return (
    <>
      ...
      <Section icon="🎨" title="Creative Skills Meet Professional Development" lead="Get Creative! bridges the gap between high school and career-ready skills, using storytelling and digital media as pathways to professional success." id="program-details">
      ...
      <Section icon="🛠️" title="Professional Skills & Industry Tools">
        <div className="grid grid-3">
          <div className="card"><span className="card-icon">💻</span><h3>Technical Skills</h3><ul><li>Adobe Creative Suite mastery</li><li>Web development basics</li><li>Video production &amp; editing</li><li>Digital photography</li></ul></div>
          <div className="card"><span className="card-icon">📊</span><h3>Professional Skills</h3><ul><li>Client communication</li><li>Project management</li><li>Portfolio presentation</li><li>Interview skills</li></ul></div>
          <div className="card"><span className="card-icon">🤝</span><h3>Career Pathways</h3><ul><li>Creative industry connections</li><li>Internship opportunities</li><li>College program alignment</li><li>Professional mentorship</li></ul></div>
        </div>
      </Section>

      <Section icon="⭐" title="Where Graduates Go">
        <div className="grid grid-3">
          {[
      ...
      <Section icon="🚪" title="Ready to Get Creative?">
        <div className="grid grid-2">
