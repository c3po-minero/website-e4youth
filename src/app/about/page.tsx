...
export default function AboutPage() {
  return (
    <>
      ...
      <Section icon="❤️" title="Built From Community, For Community">
      ...
      <Section icon="📊" title="Measurable Change, Lasting Transformation">
        <div className="stats">
      ...
      <Section icon="🏆" title="Community Recognition and Appreciation">
        <div className="grid grid-2">
          <div className="card">
      ...
      <Section icon="🚪" title="Join Our Community: There's a Place for Everyone">
        <div className="grid grid-2">
          <div className="card">
      ...
      <Section icon="💝" title="Ready to Join Our Story?" lead="Whether you're a young person ready to discover your potential, a family seeking community connection, a professional wanting to give back, or an organization interested in collaboration—E4 Youth has a place for you.">
